...
`ES-PKG-2026-004-V003-CANDIDATE-005` is a distinct fifth candidate. The failed 108-file, Candidate-003, and Candidate-004 freezes remain byte-for-byte unchanged and are referenced by their original manifest and archive SHA-256 values.
