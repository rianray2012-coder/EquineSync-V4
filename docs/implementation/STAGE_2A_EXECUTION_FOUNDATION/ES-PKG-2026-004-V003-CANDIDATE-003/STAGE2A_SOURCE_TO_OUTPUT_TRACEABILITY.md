...
Every output maps to one exact requirement, its controlling gap, named controls, source-evidence identifiers, implementation artifacts, tests, and evidence. Broad all-gap and catch-all mappings are prohibited.
