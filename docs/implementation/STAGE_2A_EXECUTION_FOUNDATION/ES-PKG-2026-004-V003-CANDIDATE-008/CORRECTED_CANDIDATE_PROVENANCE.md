...
`ES-PKG-2026-004-V003-CANDIDATE-008` is a distinct eighth candidate. The failed 108-file and Candidate-003 through Candidate-007 evidence remains byte-for-byte unchanged and is referenced by its original manifest and archive SHA-256 values.
