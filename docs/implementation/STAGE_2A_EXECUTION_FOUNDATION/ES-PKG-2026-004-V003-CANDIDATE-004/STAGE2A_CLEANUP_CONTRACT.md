...
Cleanup covers owned rows, the exact disposable database, PID/listener state, logs, snapshots, markers, and the owner-marked runtime directory. It refuses mismatched identities or active foreign listeners.
