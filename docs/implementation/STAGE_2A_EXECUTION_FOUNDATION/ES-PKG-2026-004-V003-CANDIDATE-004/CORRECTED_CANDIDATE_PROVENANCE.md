...
`ES-PKG-2026-004-V003-CANDIDATE-004` is a distinct fourth candidate. The failed 108-file and Candidate-003 freezes remain byte-for-byte unchanged and are referenced by their original manifest and archive SHA-256 values.
