# Corrected Candidate Provenance
...
`ES-PKG-2026-004-V003-CANDIDATE-006` is a distinct sixth candidate. The failed 108-file, Candidate-003, Candidate-004, and Candidate-005 evidence remains byte-for-byte unchanged and is referenced by its original manifest and archive SHA-256 values.
