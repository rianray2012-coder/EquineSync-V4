...
`ES-PKG-2026-004-V003-CANDIDATE-009` is a distinct ninth candidate. The failed 108-file and Candidate-003 through Candidate-008 evidence remains byte-for-byte unchanged and is referenced by its original manifest and archive SHA-256 values.
