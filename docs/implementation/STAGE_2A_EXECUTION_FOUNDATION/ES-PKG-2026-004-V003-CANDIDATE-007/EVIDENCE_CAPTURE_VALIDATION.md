...
Positive and intentional-failure records pass the strict schema, semantic record hash, chronology, implementation-commit binding, and stream-hash checks; a semantically empty record is rejected.
