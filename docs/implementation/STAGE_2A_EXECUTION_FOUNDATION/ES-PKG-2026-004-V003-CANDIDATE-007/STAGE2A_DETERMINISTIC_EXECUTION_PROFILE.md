# Stage 2A Deterministic Execution Profile
...
The controlled profile uses exact loopback ports, synthetic datastore identity, zero-document-write catalog control, disabled jobs, provider denial, exact process identity, and deterministic configuration hashing.
