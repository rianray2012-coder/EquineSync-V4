# Master Equine Health, Welfare, Medical Record, and Clinical Support Model V1.1

**Status:** Reconciled adoption candidate for separate founder review  
**Constitutional state:** Not adopted; not locked; non-controlling  
**Authority:** Decision reconciliation and adoption review only; no implementation, runtime, provider, production, public-claim, or launch authority  
**Founder source SHA-256:** `81d1d33d45093b89718e877330739c3601ed86ffe9ce6c476a679caab289e4d3`  
**Predecessor SHA-256:** `f68d65873599237a65006ea6ce614b427a16e259db132f36c9116b6dec90abfa`
...
It supports accurate records and coordinated care but does not replace licensed professional judgment. EquineSync does not practice veterinary medicine. EquineSync does not diagnose or prescribe, and it does not establish a veterinarian-client-patient relationship.
...
### Founder-Approved Decision Rules

**EH-FD10 approved direction:** Require separate purpose, authority, de-identification risk review, retention, opt-out/withdrawal policy, and no default model training

**Approved constitutional text:** "Clinical and welfare data shall not be used for model training or unrelated research by default."
...
**EH-FD02 approved direction:** Adopt explicit classes for canonical health facts, provider source records, private notes, facility execution, owner observations, and derived projections

**Approved constitutional text:** "Health records shall be classified by source, purpose, authorship, continuity obligation, and disclosure class before storage or projection."
...
**EH-FD01 approved direction:** Require source, jurisdiction, scope, verification time, expiry, and dispute state; never equate account type with authority

**Approved constitutional text:** "Professional clinical authority shall require current, scoped, source-attributed evidence and shall not arise from account type, appointment, payment, or document upload."
...
**EH-FD03 approved direction:** Require jurisdiction-specific registry, licensed authority where applicable, enhanced audit, dose/unit validation, and fail-closed conflicts

**Approved constitutional text:** "Controlled or legally restricted treatment shall not be ordered, represented, administered, or reconciled without the applicable governed authority and enhanced evidence controls."
...
**EH-FD12 approved direction:** Require verified decision authority, licensed involvement where required, enhanced audit, respectful restricted visibility, and no automation

**Approved constitutional text:** "Euthanasia and end-of-life decisions shall require accountable human authority and shall never be made or approved by AI or unattended automation."
...
**EH-FD14 approved direction:** Limit to retrieval/summarization and explicitly authorized low-risk support with citations, uncertainty, and qualified human review; prohibit diagnosis/prescription/execution

**Approved constitutional text:** "AI clinical support shall remain non-authoritative, source-grounded, uncertainty-labeled, and incapable of diagnosis, prescription, treatment selection, or execution."
...
**EH-FD05 approved direction:** Keep private deliberative notes source-retained by default; transfer verified horse-health facts and active care information through classified projection

**Approved constitutional text:** "Private or deliberative notes shall not transfer merely because the horse transfers; continuity shall use an approved, source-attributed projection."

**EH-FD06 approved direction:** Include minimum necessary verified active-care and safety facts, preserve source documents and restrictions, and permit dispute annotation

**Approved constitutional text:** "A health continuity package shall prioritize verified active safety and care needs while excluding unrelated private or restricted information."
...
**EH-FD07 approved direction:** Display source/rule version and evidence state; prohibit guaranteed compliance or eligibility unless authoritative confirmation exists

**Approved constitutional text:** "EquineSync shall not guarantee competition, medication, withdrawal, regulatory, or governing-body compliance from stored data alone."
...
**EH-FD08 approved direction:** Fail closed, quarantine conflict, show uncertainty, block unsafe next-dose confirmation, and require authorized reconciliation

**Approved constitutional text:** "Conflicting or stale offline medication state shall not be auto-merged into authoritative administration truth."
...
**EH-FD09 approved direction:** Preserve raw source and quality metadata; treat as evidence until verified or professionally interpreted

**Approved constitutional text:** "Imported or device-generated data shall not become verified clinical judgment solely through ingestion, transformation, or model interpretation."
...
**EH-FD04 approved direction:** Permit minimum necessary welfare escalation within founder-approved limits, preserve contact attempts, separate care authority from expense liability, and require later review

**Approved constitutional text:** "Emergency welfare action shall remain distinct from durable treatment authority and financial responsibility."

**EH-FD11 approved direction:** Permit policy-based minimum care and qualified escalation with neutral records, limits, notices, and review

**Approved constitutional text:** "Owner unreachability or suspected neglect may support narrow welfare-preserving action but shall not establish guilt, ownership, or unlimited spending authority."
...
**EH-FD13 approved direction:** Permit supervised minimum-necessary task instructions and observations; deny private clinical, owner, financial, and dispute records

**Approved constitutional text:** "Minor access to horse-health information shall be limited to the minimum necessary for safe, authorized participation."
...
## 38. Founder Decision Resolution and Retained P2

EH-FD01 through EH-FD14 are `FOUNDER_APPROVED_EXACTLY` through the uploaded founder register preserved at SHA-256 `81d1d33d45093b89718e877330739c3601ed86ffe9ce6c476a679caab289e4d3`.

P0 is 0. P1 is 0. Six P2 obligations remain for jurisdiction registries, retention, exact Privacy dependency, scenario depth, qualified review, and machine dependency/orphan scans. They are nonblocking for adoption review and binding before affected lock, implementation, activation, or claims.
