...
AI-generated or materially AI-modified assets must be explicitly labeled and disclose their origin. They must preserve the original prompt or governed prompt reference where appropriate, model and version, generation time, source inputs, permissions, human reviewer, approval status, disclosure state, and derivative lineage where policy requires. They may never silently replace originals.
...
`MASTER_MEDIA_FILES_AND_DIGITAL_ASSET_GOVERNANCE_MODEL_V1_1_READY_FOR_FOUNDER_APPROVAL_REVIEW`
