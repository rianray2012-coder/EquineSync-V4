...
def test_rf5_declares_required_enrollment_paths_without_public_phase_labels():
    ...
    assert "deferredPhase" not in enrollment_paths
    assert "RF7" not in enrollment_page
    assert "RF9" not in enrollment_page
    assert "RF10" not in enrollment_page
    assert "RF7" not in enrollment_paths
    assert "RF9" not in enrollment_paths
    assert "RF10" not in enrollment_paths
