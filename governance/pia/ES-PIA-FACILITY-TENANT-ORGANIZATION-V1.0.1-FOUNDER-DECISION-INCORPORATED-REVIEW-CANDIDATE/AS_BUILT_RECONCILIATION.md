...
## V1.0.1 design-only reconciliation

+The approved design does not convert current `barn_id`, `account_id`, primary-barn fallback, or similar compatibility fields into Tenant, Facility, Organization, Relationship, stewardship, or permission truth. Adaptive onboarding and all new requirements remain documentary target design. No code, database, schema, migration, startup, or runtime verification occurred.
