...
| VAL-CON-007 | PASS | Action-time authorization and explicit context selection remain visible |
| VAL-CON-008 | PASS | Non-cascading transitions and lineage preservation remain explicit |
