...
## FAC-WF-001 — Create first-user topology

- Actor: Authorized enrollment actor
- Preconditions: No tenant context exists
- Happy path: Create candidate Tenant, Organization association, Facility and unassigned Area; separately establish relationships/authority
- Boundary/failure: Seed does not grant authority
- Requirements: `FAC-REQ-001;FAC-REQ-031`
