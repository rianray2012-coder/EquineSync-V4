...
CLOSING = ["PROGRAM_PLAN_V1_1_CONTROLLING", "PROGRAM_REVISION_APPROVED_PENDING_PROTECTED_INTEGRATION_AND_CUSTODY", "PR_44_REMAINS_OPEN_DRAFT_UNMERGED_UNTIL_SUCCESSOR_CUSTODY_COMPLETE", "GUIDE_ACTIVATION_NOT_AUTHORIZED", "NO_ACTIVATION_EFFECTIVE_DATE_ESTABLISHED", "REPOSITORY_SPECIFIC_IMPLEMENTATION_MAPPING_NOT_AUTHORIZED", "IMPLEMENTATION_NOT_AUTHORIZED", "DEPLOYMENT_NOT_AUTHORIZED", "PILOT_AND_PRODUCTION_USE_NOT_AUTHORIZED", "GAP_0004_REMAINS_OPEN", "RETAINED_WARNINGS_REMAIN_OPEN", "ACTIVATION_BLOCKERS_REMAIN_OPEN", "NO_ADOPTED_GUIDE_BYTES_CHANGED", "NO_RUNTIME_IMPLEMENTATION_OCCURRED"]
...
def validate_all() -> list[dict[str, str]]:
    ...
    for report in [repo / PRIMARY_REL / "REVIEW_DISPOSITION.md", repo / PRIMARY_REL / "FOUNDER_REVIEW_SUMMARY.md", repo / PRIMARY_REL / "FOUNDER_DISPOSITION_OF_PR_49.md", repo / SUCCESSOR_REL / "SUCCESSOR_REVIEW_DISPOSITION.md", repo / SUCCESSOR_REL / "FOUNDER_REVIEW_SUMMARY.md", repo / SUCCESSOR_REL / "FOUNDER_DISPOSITION_OF_PR_49.md"]:
