...
**Correction counts:** `PASS`
**Approval metadata finalization:** `PASS`
**Unauthorized substantive difference:** `PASS`
**Serialization:** `PASS`
**Manifest:** `PENDING_REGENERATION_BEFORE_COMMIT`
**Checksum:** `PENDING_REGENERATION_BEFORE_COMMIT`
**Authorized paths:** `PASS`

Package-local validation and tests must pass before accession commit and PR creation.
