# ES-CG-08 - Domain Engineering Standards

- Canonical guide ID: `ES-CG-08`
- Canonical guide title: Domain Engineering Standards
...
- Expected drafting prompt ID: `CG-08-DRAFT`
