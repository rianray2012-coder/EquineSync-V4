...
**Source freeze ID:** `CGP005-SOURCE-FREEZE-ES-CG-01-20260726`

CGP-005 freezes exact source bytes for `ES-CG-01` so the guide can later enter drafting only if CGP-006 or another authorized prompt is issued. This report contains no substantive guide controls, implementation profiles, product policy, adoption, activation, or engineering-gate authority.

## Source Counts

- `CONTROLLING_FROZEN`: `397`
- `SUPPORTING_FROZEN`: `1072`
- `HISTORICAL_FROZEN`: `38`
- `IMPLEMENTATION_EVIDENCE_FROZEN`: `633`
- `EXCLUDED_PROPOSED`: `70`
- `EXCLUDED_BLOCKED`: `4`

- Total source records: `2214`
...
`ES-CG-01` remains `NOT_ADOPTED` and `NOT_ACTIVE`. CGP-005 did not begin `CG-01-DRAFT` or CGP-006.
