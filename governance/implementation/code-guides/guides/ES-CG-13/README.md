...
CGP-005 records a Founder-accepted curated normative source-freeze package while preserving the broad reference corpus as non-normative. This guide remains non-substantive, `NOT_ADOPTED`, `NOT_ACTIVE`, and not implementation-authorizing. CGP-005 did not begin `CG-13-DRAFT` or CGP-006.
