...
**Directive ID:** `CGP_006_WAVE_1_ACTIVATION_READINESS_AND_EVIDENCE_PLANNING_DIRECTIVE_V1_1_0`
**Supersedes:** `CGP_006_WAVE_1_ACTIVATION_READINESS_AND_EVIDENCE_PLANNING_DIRECTIVE_V1_0_0`
**Workstream ID:** `CGP_006_WAVE_1_ACTIVATION_AND_EVIDENCE_PLANNING`
...
The answer is `CGP_006_WAVE_1_READY_FOR_FOUNDER_ACTIVATION_CONSIDERATION_WITH_CONDITIONS`. This is a documentary readiness recommendation only. It does not activate the guides and does not authorize implementation mapping, implementation, runtime use, pilot use, production use, warning closure, or GAP-0004 closure.

## Recommended Model

The recommended model is `STAGED_ROLE_LIMITED_PORTFOLIO_ACTIVATION_FOR_GOVERNANCE_AND_EVIDENCE_PLANNING`. It is a staged and role-limited portfolio model for governance and evidence-planning reliance only, with separate authority still required before implementation mapping, implementation, or runtime evidence collection.
...
| --- | --- |
| Guides reviewed | 4 |
| Controls in abstract evidence crosswalk | 22 |
| Invariants in abstract evidence crosswalk | 22 |
| Prerequisites identified | 65 |
| Evidence items identified | 64 |
| Proposed Founder decisions | 6 |
| Activation blockers | 7 |
| Risk/finding/deviation records | 8 |
