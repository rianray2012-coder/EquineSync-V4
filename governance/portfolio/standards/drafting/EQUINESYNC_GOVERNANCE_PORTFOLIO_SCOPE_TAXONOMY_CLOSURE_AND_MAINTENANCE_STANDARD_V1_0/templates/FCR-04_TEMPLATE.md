...
- `deferred_test`: REQUIRED_NON_EMPTY
- `due_date`: REQUIRED_NON_EMPTY
- `interim_controls`: REQUIRED_NON_EMPTY
- `owner`: REQUIRED_NON_EMPTY
- `blocking_consequences`: REQUIRED_NON_EMPTY
- `expires_at`: REQUIRED_NON_EMPTY
- `mandatory_completion_trigger`: REQUIRED_NON_EMPTY
