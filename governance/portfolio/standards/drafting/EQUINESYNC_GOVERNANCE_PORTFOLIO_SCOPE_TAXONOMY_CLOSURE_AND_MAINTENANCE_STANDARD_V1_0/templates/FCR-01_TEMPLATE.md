# FCR-01 Historical Evidence Certification Template
...
- `unavailable_historical_source`: REQUIRED_NON_EMPTY
- `efforts_to_locate_source`: REQUIRED_NON_EMPTY
- `substituted_evidence`: REQUIRED_NON_EMPTY
- `limitations`: REQUIRED_NON_EMPTY
- `affected_claims`: REQUIRED_NON_EMPTY
- `review_trigger`: REQUIRED_NON_EMPTY
- `expires_at`: REQUIRED_NON_EMPTY
- `historical_fact_not_rewritten_statement`: REQUIRED_NON_EMPTY
