# FCR-02 Current-State Certification Template
...
- `exact_current_baseline`: REQUIRED_NON_EMPTY
- `inspected_repository_state`: REQUIRED_NON_EMPTY
- `evidence_examined`: REQUIRED_NON_EMPTY
- `exclusions`: REQUIRED_NON_EMPTY
- `unresolved_uncertainty`: REQUIRED_NON_EMPTY
- `affected_claims`: REQUIRED_NON_EMPTY
- `scope_limitations`: REQUIRED_NON_EMPTY
