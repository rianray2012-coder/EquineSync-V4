...
Documents the exact row population sampled and the result of each sample without treating sampling as full-population proof.

## Required Evidence Fields

`sample_id, population_definition, sample_size, selection_method, selected_row_ids, exceptions_found, reviewer_result, residual_limitation`
...
|---|---|---|---|---|
| sample_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| residual_limitation | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
