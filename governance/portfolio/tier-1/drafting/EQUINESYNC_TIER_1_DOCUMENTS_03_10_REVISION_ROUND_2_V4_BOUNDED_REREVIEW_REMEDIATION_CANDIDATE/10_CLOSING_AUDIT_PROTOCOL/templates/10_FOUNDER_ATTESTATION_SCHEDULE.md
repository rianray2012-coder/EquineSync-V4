# Founder Attestation Schedule

## Document Control

Template name: `FOUNDER_ATTESTATION_SCHEDULE`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Provides a decision frame only; no row may preselect approval or imply Founder approval without a later signed record.

## Required Evidence Fields

`attestation_id, question_presented, evidence_considered, option_selected, authority_granted, authority_not_granted, unresolved_items, signature_status`
...
|---|---|---|---|---|
| attestation_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
