# Founder Documentary Acknowledgement

## Document Control

Template name: `FOUNDER_DOCUMENTARY_ACKNOWLEDGEMENT`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Records receipt or acknowledgement only and prevents it from being mistaken for adoption, activation, merge, or production authorization.

## Required Evidence Fields

`acknowledgement_id, founder_name, package_version, acknowledgement_scope, non_authorized_effects, open_items, date, signature_status`
...
|---|---|---|---|---|
| acknowledgement_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| signature_status | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
