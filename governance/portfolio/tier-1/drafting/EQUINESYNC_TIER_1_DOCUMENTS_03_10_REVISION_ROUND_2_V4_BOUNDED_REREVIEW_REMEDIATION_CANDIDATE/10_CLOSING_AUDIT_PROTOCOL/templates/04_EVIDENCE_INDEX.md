...
Indexes evidence rows that support or fail to support each finding, decision, lifecycle transition, and template claim.

## Required Evidence Fields

`evidence_id, linked_register, linked_row_id, source_path, sha256, byte_length, reviewed_by, limitation`
...
|---|---|---|---|---|
| evidence_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| limitation | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
