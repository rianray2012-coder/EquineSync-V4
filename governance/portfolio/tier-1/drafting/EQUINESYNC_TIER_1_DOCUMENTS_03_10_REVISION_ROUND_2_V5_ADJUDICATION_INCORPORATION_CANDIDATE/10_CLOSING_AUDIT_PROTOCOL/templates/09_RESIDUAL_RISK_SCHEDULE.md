...
Template name: `RESIDUAL_RISK_SCHEDULE`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Keeps residual risk proposed treatment separate from accepted risk and Founder decision authority.

## Required Evidence Fields

`risk_id, source_finding_id, risk_statement, impact, owner, proposed_treatment, founder_decision_required, accepted_by`
...
|---|---|---|---|---|
| risk_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| accepted_by | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
