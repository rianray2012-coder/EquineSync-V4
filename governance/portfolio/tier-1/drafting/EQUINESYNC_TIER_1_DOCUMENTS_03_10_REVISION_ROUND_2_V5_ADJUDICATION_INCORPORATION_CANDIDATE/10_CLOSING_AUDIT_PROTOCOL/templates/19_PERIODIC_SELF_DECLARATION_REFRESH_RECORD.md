# Periodic Self Declaration Refresh Record

## Document Control

Template name: `PERIODIC_SELF_DECLARATION_REFRESH_RECORD`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Supports periodic documentary refresh while preserving the boundary that refresh is not activation or certification.

## Required Evidence Fields

`refresh_id, prior_record, review_period, changed_sources, unchanged_sources, new_open_items, reviewer, next_review_due`
...
|---|---|---|---|---|
| refresh_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| next_review_due | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
