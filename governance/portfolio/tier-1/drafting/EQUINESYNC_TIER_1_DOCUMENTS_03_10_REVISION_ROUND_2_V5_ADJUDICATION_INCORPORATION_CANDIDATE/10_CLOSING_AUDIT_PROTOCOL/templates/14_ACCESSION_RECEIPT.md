...
Template name: `ACCESSION_RECEIPT`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Records custody of documentary bytes without converting custody into adoption or operational effect.

## Required Evidence Fields

`accession_id, repository_ref, archive_sha256, archive_byte_length, accessioned_by, accession_date, custody_location, exclusion_note`
...
|---|---|---|---|---|
| accession_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
