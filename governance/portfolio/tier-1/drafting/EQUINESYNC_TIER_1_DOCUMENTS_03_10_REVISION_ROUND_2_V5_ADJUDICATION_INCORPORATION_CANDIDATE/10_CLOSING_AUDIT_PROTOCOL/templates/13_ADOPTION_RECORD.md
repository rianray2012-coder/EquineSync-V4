...
Reserved for a future explicit adoption act; in this package all fields remain unexecuted placeholders.

## Required Evidence Fields

`adoption_record_id, package_version, decision_text, adopted_documents, effective_date, implementation_authority, production_authority, exclusions`
...
|---|---|---|---|---|
| adoption_record_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| exclusions | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
