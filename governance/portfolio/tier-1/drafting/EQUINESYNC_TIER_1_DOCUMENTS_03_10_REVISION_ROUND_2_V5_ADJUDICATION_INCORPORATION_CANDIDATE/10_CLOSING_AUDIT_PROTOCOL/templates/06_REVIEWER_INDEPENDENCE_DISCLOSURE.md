...
Template name: `REVIEWER_INDEPENDENCE_DISCLOSURE`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Captures whether the reviewer is independent, second-party, Founder-directed, machine-assisted, or conflicted.

## Required Evidence Fields

`reviewer_id, reviewer_role, relationship_to_founder, financial_interest, prior_authoring_role, conflict_statement, independence_limitation`
...
|---|---|---|---|---|
| reviewer_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| independence_limitation | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
