# Bounded Scope Self Declaration Record

## Document Control

Template name: `BOUNDED_SCOPE_SELF_DECLARATION_RECORD`.

Template version: `V4_PURPOSE_SPECIFIC_DRAFT`.

## Purpose

Allows a narrow self-declaration for an area while preserving unresolved items outside that area.

## Required Evidence Fields

`declaration_id, bounded_area, included_rows, excluded_rows, evidence_basis, residual_open_items, non_certification_statement`
...
| non_certification_statement | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
