...
Defines who will review what evidence, how the evidence population is bounded, and which authority conclusions are prohibited.

## Required Evidence Fields

`plan_id, package_root, review_scope, reviewer_role, source_population, sampling_strategy, exclusion_basis, planned_outputs`
...
|---|---|---|---|---|
| plan_id | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
| planned_outputs | REQUIRED_BEFORE_USE | REQUIRED_BEFORE_USE | OPEN_PENDING_COMPLETION | V4 template only; not completed evidence |
