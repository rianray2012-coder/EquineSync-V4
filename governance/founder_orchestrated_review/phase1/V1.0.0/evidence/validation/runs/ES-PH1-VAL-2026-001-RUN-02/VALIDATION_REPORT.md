...
**Run:** `ES-PH1-VAL-2026-001-RUN-02`  
...
| `JSON_PARSE` | JSON parsing | `PASS` | valid_json=32; expected_malformed_detected=True; unexpected=[] |
...
| `CSV_STRUCTURE` | CSV structure | `PASS` | files=14; issues=[] |
...
| `ARCHIVE_PARITY` | archive parity and package hash | `PASS` | entries=76; name_parity=True; bad_hashes=[]; archive_sha256=71e267810fd701c398ed9f822cfa2505a0e72a049f57efc278d8b0a8a425cc03 |
