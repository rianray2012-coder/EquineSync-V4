...
**Run:** `ES-PH1-VAL-2026-001-RUN-03`  
**Overall:** `FAILED`  
**Total checks:** 32  
**Passed:** 30  
**Failed:** 1  
...
| `JSON_PARSE` | JSON parsing | `PASS` | valid_json=35; expected_malformed_detected=True; unexpected=[] |
...
| `CSV_STRUCTURE` | CSV structure | `PASS` | files=15; issues=[] |
...
| `FILENAME` | filename validation | `FAIL` | bad_required=[]; bad_profiles=['PROFILE_MANIFEST.json'] |
...
| `ARCHIVE_PARITY` | archive parity and package hash | `PASS` | entries=81; name_parity=True; bad_hashes=[]; archive_sha256=fbf94eb0b83de30c5b4c23581ec05de5df6536c0c97c8a4f8f7930882a1f6f73 |
