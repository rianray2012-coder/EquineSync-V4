...
**Run:** `ES-PH1-VAL-2026-001-RUN-05`  
...
| `JSON_PARSE` | JSON parsing | `PASS` | valid_json=39; expected_malformed_detected=True; unexpected=[] |
...
| `CSV_STRUCTURE` | CSV structure | `PASS` | files=17; issues=[] |
...
| `SECRET_SCAN` | secret scanning | `PASS` | secret_pattern_hits=[]; non-key-shaped synthetic marker allowed |
...
| `ARCHIVE_PARITY` | archive parity and package hash | `PASS` | entries=82; name_parity=True; bad_hashes=[]; archive_sha256=fc29bcd5d3a70457503decf0e53c9462b0ea09f5a7572494bd19160663fa1294 |
