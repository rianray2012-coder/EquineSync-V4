...
//   • Uses only approved EquineSync tokens (sage / lavender / amber / clay).
...
function _resolveMeter(usage, kind) {
  ...
  if (used >= limit) {
    ...
    tone = "sage"; ringClass = "border-equine-lavenderSoft/30 bg-equine-lavenderSoft/8"; barClass = "bg-equine-sage";
  }
