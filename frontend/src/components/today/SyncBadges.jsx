...
export const SyncDot = ({ state }) => {
  const map = {
    ...
    queued:  { cls: "bg-equine-lavender", label: "Queued", pulse: true },
    syncing: { cls: "bg-equine-lavender", label: "Syncing", pulse: true },
    ...
    <div
      ...
      className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-[11.5px] tracking-wide ${
        failed > 0
          ...
          : "bg-equine-lilac/10 border-equine-lilac/30 text-equine-navy"
      }`}
    >
