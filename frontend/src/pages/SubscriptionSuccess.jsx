...
export default function SubscriptionSuccess() {
  ...
  return (
    <div data-testid="subscription-success-page" className="pb-20 lg:pb-8 max-w-3xl">
      ...
      <Card hover={false} className="border-equine-lavenderSoft/40" data-testid="success-summary-card">
        <div className="flex items-start gap-4 flex-wrap">
          <div className="rounded-full bg-equine-lavenderSoft/15 p-3 border border-equine-lavenderSoft/40">
            <CheckCircle2 className="w-5 h-5 text-equine-lavenderDeep" />
          </div>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-[12.5px] tracking-wide px-4 py-2 rounded-full border border-equine-graphite/40 text-equine-ink hover:border-equine-lavenderDeep/40 hover:text-equine-lavenderDeep transition-colors"
          >
            Back to dashboard
          </Link>
        </div>
