    ...
    <div data-testid="today-page" className="pb-24 lg:pb-12 max-w-4xl mx-auto">
          ...
          <div className="ml-auto pl-2 flex items-center gap-2">
            <button
              ...
              className={`shrink-0 inline-flex items-center gap-1.5 px-4 py-2.5 min-h-[40px] rounded-full text-[12px] tracking-wide border transition-colors ${
                bulkMode ? "bg-equine-lavender text-equine-navy border-equine-lilac" : "bg-equine-card text-equine-inkMuted border-equine-hairline hover:border-equine-graphite"
              }`}
            >
      ...
      {loading && !data ? (
        ...
        <>
          ...
          {!totalActionable && (
            <Empty>
              <Sparkles className="w-7 h-7 text-equine-lilac mx-auto mb-2.5" />
      ...
      {bulkMode && selected.size > 0 && (
        ...
        >
          ...
          <Button
            ...
            className="rounded-full bg-equine-lavender text-equine-navy hover:bg-white"
          >
