        ...
        <Card>
          ...
          {vet.slice(0, 12).map((v) => (
            <div key={v.id} className="py-3 hairline">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[12.5px] text-equine-inkMuted">
                    ...
                    {v.source === "task_engine" && <span className="ml-2 text-equine-lilac text-[10.5px] uppercase tracking-[0.18em]">via engine</span>}
                  </div>
                </div>
              ...
              {v.follow_up_due && (
                <div className="text-[11.5px] text-equine-lilac mt-1.5">
              ...
              <div key={f.id} className="py-3 hairline">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    {f.next_visit_due && (
                      <div className="text-[11px] text-equine-lilac">next {fmtDate(f.next_visit_due)}</div>
                    )}
                  </div>
                </div>
        ...
        <Card className="lg:col-span-2">
          ...
          {injuries.map((i) => (
            <div key={i.id} className="py-3 hairline">
              ...
              {i.rehab_plan && (
                <div className="text-[12.5px] text-equine-lilac mt-1.5">Plan: {i.rehab_plan}</div>
              )}
            </div>
          ))}
        </Card>
