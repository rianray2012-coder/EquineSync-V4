...
export default function BarnLocations() {
  ...
  return (
    <div data-testid="barn-locations-page">
      ...
      {canPublish && (
        <Card hover={false} className="mb-6 border-equine-lilac/30 bg-equine-lilac/5" data-testid="barn-locations-share-controls">
        ...
        <>
          ...
          <Card hover={false} className="mt-6" data-testid="barn-location-pasture-map">
            <div className="flex items-center justify-between gap-4 mb-5">
              ...
              <Trees className="w-5 h-5 text-equine-lilac" />
            </div>
