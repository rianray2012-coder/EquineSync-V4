    ...
    <div data-testid="dashboard-page" className="pb-20 lg:pb-8">
      ...
      <SectionEyebrow
        action={
          <Link
            to="/today"
            className="text-[11px] uppercase tracking-[0.22em] text-equine-icy/80 hover:text-equine-icyLight inline-flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 animate-fade-in-delay-3">
        ...
        <Stat testid="stat-revenue"  label="Outstanding"      value={money(summary?.overdue_amount ?? 0)} accent="icy" caption={`${summary?.overdue_invoices ?? 0} invoice(s)`} icon={Receipt} />
      </div>
  ...
  return (
    <div className="mb-6" data-testid="dashboard-usage-snapshot">
      <div className="flex items-center justify-between mb-2">
        ...
        <Link
          to="/billing/subscription"
          className="text-[11.5px] tracking-wide text-equine-lavenderDeep hover:text-equine-ink inline-flex items-center gap-1"
