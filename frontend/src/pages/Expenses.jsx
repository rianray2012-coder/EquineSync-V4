  ...
  return (
    <div data-testid="expenses-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-6">
        ...
        <Card hover={false} className="lg:col-span-2 border-equine-lilac/30 bg-equine-lilac/5">
              ...
              return (
                <div key={record.id} className="rounded-xl border border-equine-hairline bg-equine-soft/55 p-4" data-testid={`expense-row-${record.id}`}>
                  <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                    ...
                    {data.receipt_url ? (
                      <a href={data.receipt_url} target="_blank" rel="noreferrer" className="text-[12px] text-equine-navy hover:text-equine-lilac inline-flex items-center gap-1">
