              ...
              <form onSubmit={buildReport} data-testid="custom-report-builder">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-5">
                  <label className="block">
                    ...
                    <input value={reportName} onChange={(e) => setReportName(e.target.value)} className="w-full bg-white border border-equine-cloud rounded-lg px-3 py-2.5 text-equine-ink outline-none focus:border-equine-icy" data-testid="custom-report-name" />
                  </label>
                  <label className="block">
                    <div className="label-eyebrow-muted mb-1.5">Filters JSON</div>
                    <input value={filters} onChange={(e) => setFilters(e.target.value)} className="w-full bg-white border border-equine-cloud rounded-lg px-3 py-2.5 text-equine-ink outline-none focus:border-equine-icy" data-testid="custom-report-filters" />
                  </label>
                </div>
...
const Bar = ({ label, value, invert }) => (
  <div className="mb-4">
    ...
    <div className="h-3 rounded-full bg-equine-cloud overflow-hidden">
      <div
        className={`h-full rounded-full ${invert ? "bg-equine-amber" : "bg-equine-icy"}`}
