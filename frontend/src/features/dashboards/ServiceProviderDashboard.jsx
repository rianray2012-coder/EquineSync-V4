      ...
      {!data ? (
        ...
        <>
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-5 mb-10">
            ...
            <Stat label="Farrier Records" value={counts.recent_farrier_records || 0} caption="Provider-safe context" accent="icy" icon={CalendarDays} testid="provider-stat-farrier" />
            ...
            <Panel
              ...
              render={(horse) => (
                <div>
                  ...
                  {horse.allergies?.length > 0 && <div className="text-[12.5px] text-equine-lavenderSoft mt-2">Allergies: {horse.allergies.join(", ")}</div>}
                </div>
              )}
            />
            <Panel
